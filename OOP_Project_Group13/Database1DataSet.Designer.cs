...
namespace OOP_Project_Group13 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(int userID, string name, string firstName, string status, string password, string mail, string profilePicture, System.DateTime birthday, string phone) {
            ...
            private void InitClass() {
                ...
                this.columnprofilePicture.MaxLength = 50;
        ...
        public partial class ClassDataTable : global::System.Data.TypedTableBase<ClassRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClassRow AddClassRow(int IdClasse, int Student) {
            ...
            public string status {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'status\' dans la table \'Users\' est DBNull.", e);
                    }
                }
                set {
            ...
            public string mail {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'mail\' dans la table \'Users\' est DBNull.", e);
                    }
                }
                set {
            ...
            public System.DateTime birthday {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'birthday\' dans la table \'Users\' est DBNull.", e);
                    }
                }
                set {
...
namespace OOP_Project_Group13.Database1DataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([userID] = @Original_userID) AND ([name] = @Original_name) AND ([firstName] = @Original_firstName) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)) AND ([password] = @Original_password) AND ((@IsNull_mail = 1 AND [mail] IS NULL) OR ([mail] = @Original_mail)) AND ((@IsNull_profilePicture = 1 AND [profilePicture] IS NULL) OR ([profilePicture] = @Original_profilePicture)) AND ((@IsNull_birthday = 1 AND [birthday] IS NULL) OR ([birthday] = @Original_birthday)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([userID], [name], [firstName], [status], [password], [mail], [profilePicture], [birthday], [phone]) VALUES (@userID, @name, @firstName, @status, @password, @mail, @profilePicture, @birthday, @phone);
SELECT userID, name, firstName, status, password, mail, profilePicture, birthday, phone FROM Users WHERE (userID = @userID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [userID] = @userID, [name] = @name, [firstName] = @firstName, [status] = @status, [password] = @password, [mail] = @mail, [profilePicture] = @profilePicture, [birthday] = @birthday, [phone] = @phone WHERE (([userID] = @Original_userID) AND ([name] = @Original_name) AND ([firstName] = @Original_firstName) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_status)) AND ([password] = @Original_password) AND ((@IsNull_mail = 1 AND [mail] IS NULL) OR ([mail] = @Original_mail)) AND ((@IsNull_profilePicture = 1 AND [profilePicture] IS NULL) OR ([profilePicture] = @Original_profilePicture)) AND ((@IsNull_birthday = 1 AND [birthday] IS NULL) OR ([birthday] = @Original_birthday)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)));
SELECT userID, name, firstName, status, password, mail, profilePicture, birthday, phone FROM Users WHERE (userID = @userID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userID, name, firstName, status, password, mail, profilePicture, birthday," +
        ...
        public virtual int Delete(int Original_userID, string Original_name, string Original_firstName, string Original_status, string Original_password, string Original_mail, string Original_profilePicture, global::System.Nullable<global::System.DateTime> Original_birthday, string Original_phone) {
        ...
        public virtual int Insert(int userID, string name, string firstName, string status, string password, string mail, string profilePicture, global::System.Nullable<global::System.DateTime> birthday, string phone) {
        ...
        public virtual int Update(
            ...
            if ((Original_profilePicture == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_profilePicture));
            }
            if ((Original_birthday.HasValue == true)) {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_birthday, 
                    string Original_phone) {
            return this.Update(Original_userID, name, firstName, status, password, mail, profilePicture, birthday, phone, Original_userID, Original_name, Original_firstName, Original_status, Original_password, Original_mail, Original_profilePicture, Original_birthday, Original_phone);
        }
    }
