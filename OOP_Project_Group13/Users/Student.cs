...
namespace OOP_Project_Group13.Users
{
    public class Student : User
    {
        ...
        public Student(string _name, string _firstName, string _status, string _password, int _ID, string _mail, string _phone, string _profilePicture, string _tutor, List<Grade> _gradesList, List<Attendance> _attendances, TimeTable _timetable, Class _studentClass, int _fees, DateTime _birthday, string _address) : base(_name, _firstName, _status, _password, _ID, _mail, _phone, _profilePicture)
        {
